...
> **Medium** &nbsp;&middot;&nbsp; Linked list · partial reversal + seams &nbsp;&middot;&nbsp; family: **Linked lists**
...
**▶ [Step through this solution line by line](./visualization.html)** — 14 steps, traced on `head = [1,2,3,4,5], left = 2, right = 4`.
...
[← all traced solutions](../visualizations/index.html) &nbsp;&middot;&nbsp; [pattern handbook](../PATTERNS.md) &nbsp;&middot;&nbsp; [on LeetCode](https://leetcode.com/problems/reverse-linked-list-ii)
